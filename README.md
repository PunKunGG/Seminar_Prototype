...
- วิเคราะห์ช่วง 15 วินาทีแรกของทุก 1 นาที
- ใช้ 2 เฟรมต่อวินาทีภายในช่วงที่เลือก หรือสูงสุด 30 เฟรมต่อหนึ่งนาทีของคลิป
...
ระบบตรวจบุคคลและ keypoint 17 จุดด้วย YOLOv8 Pose แล้วใช้กฎหลายสัญญาณร่วมกัน ค่า keypoint ต้องมี confidence อย่างน้อย `0.40` จึงนำมาใช้ ระบบสรุปสถิติ real-time ทุก `10 วินาที` ส่วนคลิปยาวจะวิเคราะห์ช่วงละ `15 วินาที` ในทุก 1 นาที เวลายืนยันด้านล่างเป็นระยะที่ผลต้องต่อเนื่องก่อนเปลี่ยนสถานะของบุคคล ไม่ใช่รอบการสรุปรายงาน
...
| `CLASSMOOD_REALTIME_STATS_INTERVAL` | `10` | ระยะห่างการบันทึกสถิติรวมในโหมด real-time |
